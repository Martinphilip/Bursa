...
public class AllTests  extends BaseTest {
	...
	public void MarketOverview(String testCaseID, String dataSheet) throws InterruptedException, IOException {
		TestCaseClass.equityPriceSorting(driver,testCaseID,dataSheet);
	}
